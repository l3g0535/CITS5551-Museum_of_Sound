...
from frontend.models import Production
import os
...
class UploadProductionForm(forms.Form):
    prod_title = forms.CharField(widget=forms.Textarea(attrs={'cols': 30, 'rows': 1}))
    prod_description = forms.CharField(widget=forms.Textarea(attrs={'cols': 30, 'rows': 10}))
