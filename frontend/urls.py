...
urlpatterns = [
    ...
    path(r'sound/record', views.user_record, name='user_record'),
    ...
    path('aboutus', TemplateView.as_view(template_name="frontend/aboutus.html"), name='aboutus'),
    path('licensing', TemplateView.as_view(template_name="frontend/licensing.html"), name='licensing'),
